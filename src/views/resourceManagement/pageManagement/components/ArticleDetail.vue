    ...
    <el-form class="form-container" :model="postForm" :rules="rules" ref="postForm">
      ...
      <sticky :className="'sub-navbar '+postForm.status">
        <template v-if="fetchSuccess">
          ...
          <!-- <el-button v-loading="loading" type="warning" @click="draftForm">编辑</el-button> -->
          <el-button v-loading="loading" type="danger" @click="onback">返回</el-button>
...
export default {
  ...
  methods: {
    ...
    onback() {
      this.$router.push({ path: '/resourceManagement/pageManagement' })
    },
